...
namespace Algel.WpfIconFonts
{
    ...
    /// </summary>
    public class TextIcon : TextBlock, ISpinable, IRotatable, IFlippable
    {
        /// <summary>
        /// Identifies the FontAwesome.WPF.FontAwesome.Icon dependency property.
        /// </summary>
        public static readonly DependencyProperty IconProperty =
            DependencyProperty.Register("Icon", typeof(FontIcon), typeof(TextIcon), new PropertyMetadata(FontIcon.None, OnIconPropertyChanged));

        /// <summary>
        /// Identifies the FontAwesome.WPF.FontAwesome.Spin dependency property.
        /// </summary>
        public static readonly DependencyProperty SpinProperty =
            DependencyProperty.Register("Spin", typeof(bool), typeof(TextIcon), new PropertyMetadata(false, OnSpinPropertyChanged));

        /// <summary>
        /// Identifies the FontAwesome.WPF.FontAwesome.Spin dependency property.
        /// </summary>
        public static readonly DependencyProperty SpinDurationProperty =
            DependencyProperty.Register("SpinDuration", typeof(double), typeof(TextIcon), new PropertyMetadata(1d, SpinDurationChanged, SpinDurationCoerceValue));

        /// <summary>
        /// Identifies the FontAwesome.WPF.FontAwesome.Rotation dependency property.
        /// </summary>
        public static readonly DependencyProperty RotationProperty =
            DependencyProperty.Register("Rotation", typeof(double), typeof(TextIcon), new PropertyMetadata(0d, RotationChanged, RotationCoerceValue));
        ...
        public static readonly DependencyProperty FlipOrientationProperty =
            DependencyProperty.Register("FlipOrientation", typeof(FlipOrientation), typeof(TextIcon), new PropertyMetadata(FlipOrientation.Normal, FlipOrientationChanged));
        ...
        private static void OnIconPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            d.SetValue(TextAlignmentProperty, System.Windows.TextAlignment.Center);

            var typeFace = ((FontIcon)e.NewValue).ToTypeface();
            d.SetValue(FontFamilyProperty, typeFace.FontFamily);
            d.SetValue(FontWeightProperty, typeFace.Weight);
            d.SetValue(TextProperty, ((FontIcon)e.NewValue).ToChar());
        }

        private static void OnSpinPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            if (!(d is TextIcon fontAwesome))
                return;
        ...
        {
            if (!(d is TextIcon fontAwesome) || !fontAwesome.Spin || !(e.NewValue is double) || e.NewValue.Equals(e.OldValue))
                return;
        ...
        {
            if (!(d is TextIcon fontAwesome) || !(e.NewValue is FlipOrientation) || e.NewValue.Equals(e.OldValue))
                return;
