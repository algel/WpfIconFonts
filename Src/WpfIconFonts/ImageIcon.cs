...
namespace Algel.WpfIconFonts
{
    ...
    /// </summary>
    public class ImageIcon : Image, ISpinable, IRotatable, IFlippable
    {
        /// <summary>
        /// Identifies the FontAwesome.WPF.ImageAwesome.Foreground dependency property.
        /// </summary>
        public static readonly DependencyProperty ForegroundProperty =
            DependencyProperty.Register("Foreground", typeof(Brush), typeof(ImageIcon), new PropertyMetadata(Brushes.Black, OnIconPropertyChanged));
        /// <summary>
        /// Identifies the FontAwesome.WPF.ImageAwesome.Icon dependency property.
        /// </summary>
        public static readonly DependencyProperty IconProperty =
            DependencyProperty.Register("Icon", typeof(FontIcon), typeof(ImageIcon), new PropertyMetadata(FontIcon.None, OnIconPropertyChanged));
        /// <summary>
        /// Identifies the FontAwesome.WPF.ImageAwesome.Spin dependency property.
        /// </summary>
        public static readonly DependencyProperty SpinProperty =
            DependencyProperty.Register("Spin", typeof(bool), typeof(ImageIcon), new PropertyMetadata(false, OnSpinPropertyChanged));
        /// <summary>
        /// Identifies the FontAwesome.WPF.ImageAwesome.Spin dependency property.
        /// </summary>
        public static readonly DependencyProperty SpinDurationProperty =
            DependencyProperty.Register("SpinDuration", typeof(double), typeof(ImageIcon), new PropertyMetadata(1d, SpinDurationChanged, SpinDurationCoerceValue));
        /// <summary>
        /// Identifies the FontAwesome.WPF.ImageAwesome.Rotation dependency property.
        /// </summary>
        public static readonly DependencyProperty RotationProperty =
            DependencyProperty.Register("Rotation", typeof(double), typeof(ImageIcon), new PropertyMetadata(0d, RotationChanged, RotationCoerceValue));
        /// <summary>
        ...
        public static readonly DependencyProperty FlipOrientationProperty =
            DependencyProperty.Register("FlipOrientation", typeof(FlipOrientation), typeof(ImageIcon), new PropertyMetadata(FlipOrientation.Normal, FlipOrientationChanged));
        ...
        {
            get => (FontIcon)GetValue(IconProperty);
        ...
        {
            if (!(d is ImageIcon imageAwesome)) 
                return;
        ...
        {
            if (!(d is ImageIcon imageAwesome) || !imageAwesome.Spin || !(e.NewValue is double) || e.NewValue.Equals(e.OldValue)) 
                return;
        ...
        {
            if (!(d is ImageIcon imageAwesome) || !(e.NewValue is FlipOrientation) || e.NewValue.Equals(e.OldValue)) 
                return;
        ...
        public static ImageSource CreateImageSource(FontIcon icon, Brush foregroundBrush)
        {
            var visual = new DrawingVisual();
            using (var drawingContext = visual.RenderOpen())
            {
                var formattedText = new FormattedText(icon.ToChar(), CultureInfo.InvariantCulture, FlowDirection.LeftToRight, icon.ToTypeface(), 100, foregroundBrush)
                {
